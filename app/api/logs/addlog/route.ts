...
function getChangedFields(before: any, after: any): { before: any; after: any } | null {
...
export async function POST(req: Request) {
  try {
    ...
    const logData: Prisma.LogsCreateInput = {
      ...rest,
      before: changedFields?.before !== undefined ? changedFields.before : Prisma.JsonNull,
      after: changedFields?.after !== undefined ? changedFields.after : Prisma.JsonNull,
    };
